...
ALCOHOL_SENSOR_STATE_T alcohol_sensor_state = {
    .dp_id_alcohol_value = DP_ID_ALCOHOL_VALUE,
    .alcohol_value = 0,
};
...
VOID_T hw_report_all_dp_status(VOID_T)
{
    ...
    /* 酒精传感器ad值 */
    dp_arr[0].dpid = alcohol_sensor_state.dp_id_alcohol_value;
    dp_arr[0].type = PROP_VALUE;
    dp_arr[0].time_stamp = 0;
    dp_arr[0].value.dp_value = alcohol_sensor_state.alcohol_value;
